...
- (NSString *)getLogTypeNameLogLevel:(KmmsharedmoduleAFGrayLoggerLogLevel *)logLevel __attribute__((swift_name("getLogTypeName(logLevel:)")));
...
- (void)debugMsg:(NSString *)msg tag:(NSString *)tag __attribute__((swift_name("debug(msg:tag:)")));
- (void)errorMsg:(NSString *)msg tag:(NSString *)tag __attribute__((swift_name("error(msg:tag:)")));
- (void)infoMsg:(NSString *)msg tag:(NSString *)tag __attribute__((swift_name("info(msg:tag:)")));
...
- (void)warningMsg:(NSString *)msg tag:(NSString *)tag __attribute__((swift_name("warning(msg:tag:)")));
@end;
